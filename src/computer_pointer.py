...
--fd_model models/2020.2/FP32-INT1/face-detection-adas-binary-0001 \
--fl_model models/2020.2/FP16-INT8/landmarks-regression-retail-0009 \
--hp_model models/2020.2/FP16-INT8/head-pose-estimation-adas-0001 \
--ga_model models/2020.2/FP16-INT8/gaze-estimation-adas-0002 \
--threshold 0.7 \
--input_type video \
--device CPU \
--version 2020 \
